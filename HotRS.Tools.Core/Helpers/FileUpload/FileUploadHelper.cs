...
public class FileUploadHelper : IFileUploadHelper
{
    ...
    public async Task<string> UploadAsync(HttpContext context, FormOptions _defaultFormOptions, string fileStorePath)
    {
        ...
        ArgumentNullException.ThrowIfNull(_defaultFormOptions, nameof(_defaultFormOptions));
        ...
        var boundary = MultipartRequestHelper.GetBoundary(
            MNHH.MediaTypeHeaderValue.Parse(context.Request.ContentType),
        ...
        while (section != null)
        {
            var hasContentDispositionHeader = MNHH.ContentDispositionHeaderValue.TryParse(section.ContentDisposition, out var contentDisposition);
            ...
            if (hasContentDispositionHeader)
            {
                ...
                else if (MultipartRequestHelper.HasFormDataContentDisposition(contentDisposition))
                {
                    ...
                    {
                        throw new HotRSToolsException($"Form key count limit {_defaultFormOptions.ValueCountLimit} exceeded.");
                    }
                }
            }
    ...
    public Encoding GetEncoding(MultipartSection section)
    {
        ...
        var hasMediaTypeHeader = MNHH.MediaTypeHeaderValue.TryParse(section.ContentType, out var mediaType);
