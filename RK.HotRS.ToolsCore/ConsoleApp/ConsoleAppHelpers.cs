...
namespace RK.HotRS.ToolsCore.ConsoleApp
{
    public static class ConsoleAppHelpers
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Globalization", "CA1303:Do not pass literals as localized parameters", Justification = "To much trouble")]
        private static void CloseIfNotAborted(int seconds = 60)
        {
